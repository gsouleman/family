      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 px-4 py-2 bg-primary hover:bg-primary/90 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {asset.status === 'active' && (
            <button
              ...
              className="px-4 py-2 bg-[#d4af37] hover:bg-[#c9a432] text-primary text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
